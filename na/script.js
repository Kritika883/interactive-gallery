...
const images = [
    ...
    { src: 'OIP (9).jpeg', hdSrc: 'OIP (9).jpeg', caption: 'Wow, that reflection is so cool! Its like a mirror to nature. Love the peaceful vibe it gives off.' },
    { src: 'OIP (10).jpeg', hdSrc: 'OIP (10).jpeg',caption: 'That book looks like a gateway to another world! Ready to dive into an adventure' },
    { src: 'OIP(11).jpeg', hdSrc: 'OIP(11).jpeg', caption: 'The river winding through the forest looks so serene and peaceful. Natures beauty never fails to amaze!' },
    { src: 'OIP(12).webp', hdSrc: 'OIP(12).webp', caption: 'Books and glasses, a classic combo! Looks like a recipe for a cozy reading night.' },


    // Add more images (12 total)
];
